          ...
          <div className="max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <Button
                variant="outline"
                size="lg"
                className="px-8 py-4 text-lg rounded-xl border-slate-300 dark:border-border hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all duration-200"
              >
